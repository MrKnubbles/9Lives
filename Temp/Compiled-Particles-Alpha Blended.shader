...
SubShader { 
 ...
 //        d3d11: 10 avg math (6..14)
 //     d3d11_9x: 10 avg math (6..14)
 // Stats for Fragment shader:
 //         d3d9: 6 avg math (3..9), 1 avg texture (1..2)
 //        d3d11: 5 avg math (2..8), 1 avg texture (1..2)
 //     d3d11_9x: 5 avg math (2..8), 1 avg texture (1..2)
 Pass {
  Tags { "QUEUE"="Transparent" "IGNOREPROJECTOR"="true" "RenderType"="Transparent" "PreviewType"="Plane" }
  ZWrite Off
  Cull Off
...
Vector4 _MainTex_ST at 5
Vector4 _TintColor at 4
...
Matrix4x4 glstate_matrix_mvp at 0
Vector4 _MainTex_ST at 9
Vector4 _ProjectionParams at 7
Vector4 _TintColor at 8
...
//
   ...
   5: mul o1.xyzw, v1.xyzw, cb0[2].xyzw
...
//
  ...
  10: mul o0.xyzw, r0.xyzw, r1.xyzw
  11: ret 
// Approximately 0 instruction slots used
...
//
   ...
   2:     mad r0, c6, v0.z, r0
   3:     add r0, r0, c7
   4:     mul r1.x, r0.y, c3.x
   5:     mul r1.w, r1.x, c12.x
   6:     mul r1.xz, r0.xyww, c12.x
   7:     add oT2.xy, r1.z, r1.xwzw
   8:     mul r1.x, v0.y, c9.z
   9:     mad r1.x, c8.z, v0.x, r1.x
  10:     mad r1.x, c10.z, v0.z, r1.x
  11:     add r1.x, r1.x, c11.z
  12:     mov oT2.z, -r1.x
  13:     mul oT0, v1, c1
  14:     mad oT1.xy, v2, c2, c2.zwzw
...
//
   ...
   2:     texld r0, r0, s1
   2:     texld r1, t1, s0
   2:     mad r0.x, c1.z, r0.x, c1.w
   3:     rcp r0.x, r0.x
   4:     add r0.x, r0.x, -t2.z
   5:     mul_sat r0.x, r0.x, c0.x
   6:     mul_pp r0.w, r0.x, t0.w
   7:     mov r0.xyz, t0
   8:     add r0, r0, r0
   9:     mul_pp r0, r1, r0
  10:     mov_pp oC0, r0
